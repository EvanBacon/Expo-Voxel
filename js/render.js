...
import {mat4} from './glMatrix-1.2.min.js'
// console.log("BATMAN", mat4);
...
*/
	...
	// (async () => {
	// 	this.terrainTexture = Asset.fromModule(
...
export const pushQuad = ( v, p1, p2, p3, p4 ) =>
{
