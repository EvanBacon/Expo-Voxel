...
Highlighter.prototype.highlight = function () {
  ...
  if (this.selectActive()) {
    if (!this.selectStart) { // start a new selection
      ...
      if (endCandidate[0] !== this.selectEnd[0]
       ...
       || endCandidate[2] !== this.selectEnd[2]) {
        ...
        this.emitter.emit('highlight-select', { start: this.selectStart.slice(), end: this.selectEnd.slice() })
    ...
    if (this.selectStart) {
      this.emitter.emit('highlight-deselect', { start: this.selectStart.slice(), end: this.selectEnd.slice() })
