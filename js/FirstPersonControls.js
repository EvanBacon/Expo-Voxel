...
export default class FirstPersonControls {
  ...
  //
  //
  //   this.object.translateX(movement.x)
  //   this.object.translateY(movement.y)
  //   this.object.translateZ(movement.z)
  // }
  //
  // rotate = (delta) => {
  //
  ...
  update = (dt, direction) =>
  {
  	...
  	var pos = this.pos;
  	var bPos = new THREE.Vector3( Math.floor( pos.x ), Math.floor( pos.y ), Math.floor( pos.z ) );
